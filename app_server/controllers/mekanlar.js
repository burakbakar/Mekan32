...
var apiSecenekleri = {
  sunucu : "http://localhost:3000", //heroku kullanılırken heroku adı kullanılır burada.
  apiYolu: '/api/mekanlar/'
}


var mesafeyiFormatla = function (mesafe) {
  var yeniMesafe, birim; //mesafenin 1k den fazlaysa km olarak , az ise metre olarak göstermesini sağlar
  if (mesafe> 1000) {
  ...
  var anaSayfaOlustur = function(req, res,cevap, mekanListesi){ //var = fonksiyon
  var mesaj;
...
var detaySayfasiOlustur = function(req, res,mekanDetaylari){
 ...
 { 
  baslik: mekanDetaylari.ad, //mekanın adı
